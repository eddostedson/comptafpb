...
⏳ Attends qu'il soit prêt (icône verte)   Révision du er juillet  au 31 Décembre 2025  Assurer la motivation du pesonnel et d'autres acteurs FBP Primes personnel T1 2023

Vous pouvez maintenant démarrer l’application :
cd backend; pnpm dev:backend  \*\* pnpm run start:dev
cd backend pnpm prisma db push \* pnpm prisma generate
cd frontend; pnpm dev       \* pnpm dev:frontend

4️⃣ Lance l'application
dans cursor
cd C:\\Users\\rise\\Desktop\\CURSOR\_PROJECTS\\comptafpb
docker-compose up -d
...
docker restart cgcs\_frontend cgcs\_backend cgcs\_postgres
...
3. CHEF\_CENTRE (Chef de centre de santé)
...
chef1@cgcs.cg	chef123	CHEF\_CENTRE	Chef du centre CS-0001
...
10. Dashboard affiche selon le rôle
    ...
    * CHEF\_CENTRE → Dashboard du centre
